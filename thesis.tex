...
\chapter{EnerJ, a Safe and General Language Abstraction}
\label{ch:enerj}
...
\chapter{Controlling Quality with Probabilistic Assertions}
\label{ch:passert}
...
\chapter{ACCEPT, Open-Source Approximation Infrastructure}
\label{ch:accept}
