...
The DECAF type system, in Chapter~\ref{ch:decaf}, and
probabilistic assertions, in Chapter~\ref{ch:passert}}, represent two
...
The EnerJ language in Chapter~\ref{ch:enerj} was initially designed for
...
The ACCEPT compiler in Chapter~\ref{ch:accept} bridges the gap: its analysis
