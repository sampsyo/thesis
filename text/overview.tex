...
The EnerJ type system in \chref{enerj} embodies this distinction by
building an abstraction for safety properties.
The quality-focused mechanisms in \plurchref{decaf} and~\ref{ch:passert}
