...
\textit{How should compilers re-use approximate code in contexts
...
\lang also relates to systems for optimizing precision in floating-point
code.
Precimonious~\cite{precimonious} chooses bitwidths to meet an output precision
bound, and \citet{stoke-fp} design a superoptimizer that
