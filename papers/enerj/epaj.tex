...
DRAM and SRAM approximation is quantified the proportion of byte-seconds in
the execution.
The data shows that
...
The rest of this part of the dissertation shifts focus from enforcing safety
