...
\affil{University of Washington}
Karin Strauss
\affil{Microsoft Research and University of Washington}
Luis Ceze
\affil{University of Washington}
}
...
\result{mlc-stripe-mean-speedup} faster on average and using failed blocks can
improve array lifetime by \result{recycle-mean-all-ext} on average with quality loss under 10\%.
\end{abstract}

\category{B.3.4}{Memory Structures}{Reliability, Testing, and Fault Tolerance}
\category{D.4.2}{Operating Systems}{Storage Management}[main memory, secondary
storage]

\terms{Reliability, Performance}

\keywords{Approximate computing, storage, error tolerance, phase-change
memory}

\acmformat{Adrian Sampson, Jacob Nelson, Karin Strauss, and Luis Ceze.
